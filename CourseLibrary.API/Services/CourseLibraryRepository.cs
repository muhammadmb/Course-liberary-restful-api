...
namespace CourseLibrary.API.Services
{
    public class CourseLibraryRepository : ICourseLibraryRepository, IDisposable
    {
        ...
        public IEnumerable<Author> GetAuthors(AuthorResourceParameters authorResourceParameters)
        {
            ...
            {
                var searchQueary = authorResourceParameters.SearchQuery.Trim();
                collection = collection.Where(a => a.MainCategory.Contains(searchQueary)
                    || a.FirstName.Contains(searchQueary)
                    || a.LastName.Contains(searchQueary)
                );
            }
